...
また、「仕組み」より「学習」にスポットライトが当たるようになった。生徒がテクノロジーを使い、自分のペース・自分に合った学び方で学ぶ「個別学習」教材の研究開発にも、イースト・パロアルトへの寄付金が[使われている](http://time.com/4132619/mark-zuckerberg-personalized-learning/)。
